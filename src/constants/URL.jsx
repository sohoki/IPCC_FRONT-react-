const URL = {
    ...
    IVR_HOLY_EXCEL_UPLOAD: "/api/interface/int/diotis/holy/uploadExcel.do",
    ...
    // 내선번호 관리 (Station)
    STATION_LIST: "/api/backoffice/ipcc/avaya/pbx/station/list.do",
    STATION_INFO: "/api/backoffice/ipcc/avaya/pbx/station",
    STATION_UPDATE: "/api/backoffice/ipcc/avaya/pbx/station/update.do",
    STATION_CHECK: "/api/backoffice/ipcc/avaya/pbx/station/check",
    STATION_RANDOM: "/api/backoffice/ipcc/avaya/pbx/station/random",
    STATION_EXCEL_UPDATE: "/api/backoffice/ipcc/avaya/pbx/station/excelUpdate.do",
    STATION_LIST_UPDATE: "/api/backoffice/ipcc/avaya/pbx/station/updateExtesionList.do",
    STATION_PBX_SEARCH: "/api/backoffice/sys/sms/SmsTrank/notiSeq.do",
    // 에이전트 관리
    ...
    VENDER_STATE_UPDATE:   "/api/backoffice/infra/cor/com/companyStateUpdate.do",
    VENDER_USEYN_UPDATE:   "/api/backoffice/infra/cor/com/companyUseynUpdate.do",
    // 거래처 담당자 관리
    VENDER_USER_LIST:      "/api/backoffice/infra/vender/user/VendorUserListAjax.do",
    VENDER_USER_INFO:      "/api/backoffice/infra/vender/user",
    VENDER_USER_UPDATE:    "/api/backoffice/infra/vender/user/updateVenderUser.do",
    VENDER_USER_ID_CHECK:  "/api/backoffice/infra/vender/user/idCheck",
    VENDER_USER_PWD_RESET: "/api/backoffice/infra/vender/user/passwordReset",
    VENDER_USER_COMBO:     "/api/backoffice/infra/vender/user/VendorUserCombo.do",
    // SKILL 관리
