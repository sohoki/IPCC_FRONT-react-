    ...
    const handleDelete = useCallback(async (loginId) => {
        ...
        try {
            ...
            if (json?.STATUS === 'SUCCESS' || json?.resultCodeInfo === 'SUCCESS') {
                await Swal.fire({ icon: 'success', title: '삭제', text: json?.MESSAGE || '삭제되었습니다.' });
                handleSearch(1);
            } else {
                await Swal.fire({ icon: 'error', title: '오류', text: json?.MESSAGE || '삭제에 실패했습니다.' });
                handleSearch(1);
            }
        } catch (e) {
    ...
    return (
        <div className="row g-0 main-contents">
            <div className="col-12 content-header">
                <div className="content-header__title">에이전트 현황</div>
                <div className="content-header__breadcrumb">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item">IPCC 관리</li>
                        <li className="breadcrumb-item">에이전트 현황</li>
                    </ol>
                </div>
            </div>
