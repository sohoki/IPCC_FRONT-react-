...
const VocInfo = () => {
    ...
    const handleDelete = useCallback(async (vocSeq) => {
        const first = await Swal.fire({
            icon: 'question', title: '장애 처리 삭제',
            html: `<b>${vocSeq}</b> 를 삭제 하시겠습니까?`,
        ...
        const second = await Swal.fire({
            icon: 'warning', title: '장애 처리 삭제 확인',
            html: `<b>${vocSeq}</b> 삭제하시겠습니까?`,
            showCancelButton: true, confirmButtonText: '예', cancelButtonText: '아니오',
            focusCancel: true,
        });
    ...
    const columnDefs = useMemo(() => [
        { headerName: '위치',      field: 'vocLocation',   flex: 1 },
        { headerName: 'VOC 구분',  field: 'vocGubunTxt',   width: 110 },
        { headerName: '처리 현황', field: 'vocProcessTxt', width: 110 },
        { headerName: '요청일자',  field: 'vocReqRegdate', width: 130 },
        { headerName: '요청자',    field: 'vocReqNm',      width: 100 },
        { headerName: '담당자',    field: 'vocResNm',      width: 100 },
        { headerName: '처리일자',  field: 'vocResRegdate', width: 130 },
        {
            headerName: '처리현황', width: 80, sortable: false, filter: false,
            cellRenderer: (p) => (
        ...
        {
            headerName: '전체현황', width: 80, sortable: false, filter: false,
            cellRenderer: (p) => (
                <button className="btn btn-sm btn-outline-secondary"
    ...
    return (
        <div className="row g-0 main-contents">
            <div className="col-12 content-header">
                <div className="content-header__title">장애 현황</div>
                <div className="content-header__breadcrumb">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item">서비스</li>
                        <li className="breadcrumb-item">장애 현황</li>
                    </ol>
                </div>
            </div>
