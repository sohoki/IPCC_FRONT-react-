...
const CtiLoginInfo = () => {
    ...
    const handleDelete = useCallback(async (loginId, centerId, mediaId) => {
        ...
        const second = await Swal.fire({
            icon: 'warning', title: 'LoginId ??†ú ?ïÏù∏',
    ...
    const columnDefs = useMemo(() => [
        { headerName: 'Î°úÍ∑∏?∏ID', field: 'loginId', width: 150 },
        { headerName: 'ÏßÄ??,     field: 'centerName', flex: 1 },
        { headerName: 'ÎØ∏Îîî??,   field: 'mediaName', flex: 1 },
        { headerName: 'Í∞êÏãú',     field: 'monitorFlag', width: 90 },
        { headerName: '?ùÏÑ±??,   field: 'createDate', width: 150 },
        {
    ...
    return (
        <div className="row g-0 main-contents">
            <div className="col-12 content-header">
                <div className="content-header__title">CTI Î°úÍ∑∏??Í¥ÄÎ¶?/div>
                <div className="content-header__breadcrumb">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item">?∏ÌîÑ??Í¥ÄÎ¶?/li>
                        <li className="breadcrumb-item">CTI Î°úÍ∑∏??Í¥ÄÎ¶?/li>
                    </ol>
                </div>
            </div>
