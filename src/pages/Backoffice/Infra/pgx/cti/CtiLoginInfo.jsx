...
const CtiLoginInfo = () => {
    ...
    const columnDefs = useMemo(() => [
        { headerName: '로그?�ID', field: 'loginId', width: 150 },
        { headerName: '지??,     field: 'centerName', flex: 1 },
        { headerName: '미디??,   field: 'mediaName', flex: 1 },
        { headerName: '감시',     field: 'monitorFlag', width: 90 },
        { headerName: '?�성??,   field: 'createDate', width: 150 },
        {
    ...
    return (
        <div className="row g-0 main-contents">
            <div className="col-12 content-header">
                <div className="content-header__title">CTI 로그??관�?/div>
                <div className="content-header__breadcrumb">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item">?�프??관�?/li>
                        <li className="breadcrumb-item">CTI 로그??관�?/li>
                    </ol>
                </div>
            </div>
