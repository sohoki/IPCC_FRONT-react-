...
const PbxIpList = () => {
    ...
    const handleOpenFormModal = useCallback((rowData) => {
    ...
    const handleDelete = useCallback(async (extension) => {
        ...
        try {
            const res = await fnAjaxFetch({
                url: `${URL.IP_INFO}/${encodeURIComponent(extension)}.do`,
                method: 'DELETE',
        ...
        },
        {
            ...
            cellRenderer: (p) => (
                <button
                    ...
                    onClick={() => handleDelete(p.data?.extension)}
                >
                    삭제
                </button>
            ),
    ...
    return (
        <div className="row g-0 main-contents">
            <div className="col-12 content-header">
                <div className="content-header__title">IP 내선 관리</div>
                <div className="content-header__breadcrumb">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item">인프라 관리</li>
                        <li className="breadcrumb-item">IP 내선 관리</li>
                    </ol>
                </div>
            </div>
                ...
                <div className="row g-0 w-100 justify-content-between">
                    <div className="col-auto content-search__option d-flex gap-2 align-items-center flex-wrap">
                        ...
                        >
                            ...
                            <option value="EXTENSION">내선번호</option>
                        </select>
                        <input
                            type="text"
                            name="searchKeyword"
